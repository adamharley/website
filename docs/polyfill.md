...
> 🚨 As of Babel 7.4.0, this package has been deprecated in favor of directly including `core-js` (to polyfill ECMAScript features) and `regenerator-runtime` (needed to use transpiled generator functions):
> ```js
> import "core-js";
